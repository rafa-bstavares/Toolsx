...
export default function Petala3({index, petalaAtual, containerPetalas, clicouDireita,  clicouEsquerda, setClicouDireita, setClicouEsquerda}: Props){
    ...
    return (
        <div ref={petalaa} className={`petala${index} absolute flex justify-center items-center left-1/2 top-0 h-[20vw] z-${zIndex} -translate-x-1/2 w-96 origin-bottom`}>
            <div className=" h-full w-full"> {/* Se tirar o flex justicenter itemcenter daqui fica tipo uma lente de camera abrindo */}
